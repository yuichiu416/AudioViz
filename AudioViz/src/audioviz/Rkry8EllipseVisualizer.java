 ...
 * @author dale
 */
public class Rkry8EllipseVisualizer implements Visualizer {
    
    private final String name = "Rkry8 Ellipse Visualizer";
    ...
    public void start(Integer numBands, AnchorPane vizPane) {        
        ...
        for (int i = 0; i < numBands; i++) {
            ...
            ellipse.setFill(Color.LAVENDER);
    ...
    public void update(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        for(int i = 0; i < num; i++){
            ellipses[i].setRadiusX( ((60.0 + magnitudes[i])/60.0) * halfBandHeight + minEllipseRadius);            
            ellipses[i].setCenterX( ((60.0 + magnitudes[i])/60.0) * halfBandHeight * 2 + minEllipseRadius);
            ellipses[i].setCenterY( ((60.0 + magnitudes[i])/60.0) * halfBandHeight * 1.5 + minEllipseRadius);
            ellipses[i].setRotate(135);
